...
setup(
    name='Finance',  # Use a more Pythonic name; underscores instead of spaces
    version='0.0.1',
    author='Oliseh Okiah',
    ...
    url='https://github.com/OlisehOkiah/financial-news.git',  # URL to your project’s homepage or repository
